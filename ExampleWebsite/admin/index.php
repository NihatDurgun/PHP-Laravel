...
error_reporting(E_ERROR | E_PARSE);
    ...
    {    
        ...
        $status = CheckAdmin($_POST["username"],$_POST["password"]);
        if($status == true){
            header("location:dashboard.php");
        }
    }
                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" method="post">
                            <div class="text-center">
                                <imgsrc="..\admin\files\assets\images\logo.png" alt="logo.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="username" class="form-control" required="" placeholder="Email Address">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" name="login" value="Login" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Sign in</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
