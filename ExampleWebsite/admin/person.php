...
<?php
    ...
    if(  !is_null($_POST["FormEdit"] || !is_null($_POST["FormAdd"])  )){
        ...
        if(  !is_null($_POST["FormEdit"])){
            $result = updateUser($_POST["UserID"],$Name,$Surname,$UserName,$UserPassword,$Mail);
        }else if( !is_null($_POST["FormAdd"])){
            $result = addUser($Name,$Surname,$UserName,$UserPassword,$Mail);
        }
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Person</a>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-styling">
                                                            ...
                                                            <th>
                                                                    <select name="PageSelect" onchange="this.form.submit()">
                                                                        <?php
                                                                                ...
                                                                                $TotalCount=GetAllAccountsCount();
                                                        ...
                                                        <?php
                                                        if($page == 1){
                                                            $Pages = GetLimitAccounts(0,10);
                                                        }else{
                                                            $Pages = GetLimitAccounts( ( ($page-1)*10)-1,10);
                                                        }
                                                        $x=($page-1)*10;
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form  method="post" class="j-pro" novalidate="">
                                                                <div class="j-content">
                                                                    <!-- start name -->
                                                                    <div class="j-unit">
                                                                        <label class="j-label">UserID</label>
                                                                        <div class="j-input">
                                                                            <label class="j-icon-right" for="ProductName"> <i class="icofont icofont-options"></i></label>
                                                                            <input type="text" placeholder="if you want update user,you must fill UserID in this place"  name="UserID">
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <i class="icofont icofont-info"></i>    
                                                                        ...
                                                                        <div class="j-span6 j-unit">
                                                                            <label class="j-label">Surname</label>
                                                                            <div class="j-input">
                                                                                <label class="j-icon-right" for="DBID">
                                                                                <i class="icofont icofont-info"></i>    
                                                                    ...
                                                                    <div class="j-row">
                                                                        <div class="j-span6 j-unit">
                                                                            <label class="j-label">User Name</label>
                                                                            <div class="j-input">
                                                                                <label class="j-icon-right" for="DBID">
                                                            ...
                                                            <i class="icofont icofont-ui-password"></i>
                                                                    ...
                                                                    <div class="j-divider j-gap-bottom-25"></div>
                                                                    <div class="j-unit">
                                                                        <label class="j-label">Mail Address</label>
                                                                        <div class="j-input">
                                                                            <label class="j-icon-right" for="ProductName"> <i class="icofont icofont-ui-email"></i></label>
                                                                            <input type="text" placeholder="abc@gmail.com"  name="Mail">
                                                                        </div>
                                                                    </div>
                                                                    <!-- end name -->
                                                                    <!-- start email phone -->
