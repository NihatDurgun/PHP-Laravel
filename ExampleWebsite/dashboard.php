                                                    ...
                                                    <div class="card-block">
                                                        <div class="row m-b-25">
                                                            <div class="col-auto p-r-0">
                                                                <div class="u-img">
                                                                    <img src="..\admin\files\assets\images\breadcrumb-bg.jpg" alt="user image" class="img-radius cover-img">
                                                                    <img src="..\admin\files\assets\images\avatar-2.jpg" alt="user image" class="img-radius profile-img">
                                                                </div>
                                                            </div>
                                                            <div class="col">
...
<![endif]-->
    ...
    <!-- Required Jquery -->
    <script data-cfasync="false" src="..\admin\\\cdn-cgi\scripts\5c5dd728\cloudflare-static\email-decode.min.js"></script><script type="text/javascript" src="..\admin\files\bower_components\jquery\js\jquery.min.js"></script>
