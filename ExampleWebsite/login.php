<?php include("header.php"); loginactive(); ?>
<?php
	include getcwd().'/src/DatabaseOperation.php';
	$Data = GetPageDatas("login");
?>
...
<!--===============================================================================================-->
	<script src="login/js/maincode.js"></script>
...
<?php
	...
	if($_SESSION["userid"] == -1 || is_null($_SESSION["userid"]) ){
		...
		{    
			$userid = CheckUser($_POST["username"],md5($_POST["password"]));
			if($userid != -1){
...
echo '<meta http-equiv = "refresh" content = "0; url = https://amco.website/index.php" />';
